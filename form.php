...
If a class is currently full it will be grayed out and will not be selectable, please chose another option and contact us for more information on waitlisting classes.
        ...
        <div class="scheduleform">
            <table class="center" border="1">
                ...
                <tr> <td rowspan='3' class='nonselectable'><h3>Mon<br /> 15 April</h3></td ></tr>
            ...
            <table class="center" border="1">
                <tr> <th width=8%>Day</th> <th width=12%>Time</th><th width=40%>Daniela & Luis</th><th width=40%>Juan & Sol</th></tr>
                <tr> <td rowspan='5' class='nonselectable'><h3>Wed <br /> 17 April</h3></td> <td class='nonselectable'>12-1:30pm</td> <td class='aqua'>The Silky Embrace: Effortless and Sensitive Connection<br />(Prince George's Room)</td><td class='alice'>Wax On Wax Off: Mastering Rotation<br />Within Your Own Space<br />(Atrium)</td></tr>
